...
function renderContent()
{
    ...
    <div class="page-header">
        <div class="breadcrumb"><a href="/admin/">Accueil</a> &rsaquo; Noah</div>
    ...
    <style>
        ...
        .noah-card-chevron { margin-left: auto; color: #7a9ab8; font-size: .8rem; transition: transform .2s; }
        ...
        .noah-input:focus, .noah-select:focus { border-color: #c9a84c; }
