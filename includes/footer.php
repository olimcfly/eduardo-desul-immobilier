<?php
/**
 * footer.php - Footer réutilisable pour PUBLIC
 * Chemin : /front/includes/footer.php (ou /includes/footer.php selon ton arborescence)
 * 
 * Utilisé par : page.php, article.php, contact.php, etc.
 * 
 * ⚡ Version dynamique : lit les valeurs depuis admin_settings
 *    Si SiteSettings n'est pas initialisé, fallback sur des valeurs par défaut
 */
