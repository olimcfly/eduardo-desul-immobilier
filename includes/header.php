<?php
/**
 * header.php - Header réutilisable pour PUBLIC
 * Chemin : /front/includes/header.php (ou /includes/header.php)
 * 
 * Utilisé par : page.php, article.php, contact.php, etc.
 * 
 * Variables attendues (optionnelles - fallback vers admin_settings) :
 * - $pageTitle       : titre de la page
 * - $pageDescription : description SEO
 * - $pageKeywords    : mots-clés SEO
 * - $pageOgImage     : image Open Graph
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/acheter">🏡 Acheter</a></li>
                            <li><a class="dropdown-item" href="/vendre">💼 Vendre</a></li>
                            <li><a class="dropdown-item" href="/louer">🔑 Louer</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="/estimation">📊 Estimation gratuite</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link btn btn-outline-primary btn-sm ms-2" href="<?= $phoneLink ?>" style="border-color: var(--color-secondary, #c9a84c); color: var(--color-secondary, #c9a84c);">
                            <i class="fas fa-phone-alt"></i> <?= htmlspecialchars($phoneFormatted) ?>
                        </a>
                    </li>
                    <?php endif; ?>
