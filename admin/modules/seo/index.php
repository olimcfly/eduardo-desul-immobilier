...
.mod-ico{width:64px;height:64px;border-radius:12px;background:#f59e0b18;color:#f59e0b;
...
<div class="page-hd">
  <div>
    <h1><i class="fas fa-search" style="color:#f59e0b;margin-right:8px"></i>SEO</h1>
    <div class="page-hd-sub">SEO</div>
  </div>
</div>
<div class="mod-wrap anim">
  <div class="mod-ico"><i class="fas fa-search"></i></div>
  <h2>SEO</h2>
