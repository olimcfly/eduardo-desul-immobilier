<?php
/**
 * courtiers-index.php — Courtiers Partenaires
 * IMMO LOCAL+
 */
...
$pageTitle = 'Courtiers Partenaires';
...
<div class="page-hd">
  <div>
    <h1><i class="fas fa-briefcase" style="color:#14b8a6;margin-right:8px"></i>Courtiers Partenaires</h1>
    <div class="page-hd-sub">Network</div>
  </div>
</div>
<div class="mod-wrap anim">
  <div class="mod-ico"><i class="fas fa-briefcase"></i></div>
  <h2>Courtiers Partenaires</h2>
