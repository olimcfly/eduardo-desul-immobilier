<?php
/**
 * diagnostic-index.php — Diagnostic Système
 * IMMO LOCAL+
 */
...
<div class="page-hd">
  <div>
    <h1><i class="fas fa-stethoscope" style="color:#64748b;margin-right:8px"></i>Diagnostic Système</h1>
    <div class="page-hd-sub">Système</div>
  </div>
</div>
<div class="mod-wrap anim">
  <div class="mod-ico"><i class="fas fa-stethoscope"></i></div>
