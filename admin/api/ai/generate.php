...
case 'builder.generate': {
    ...
    $typeInstructions = match($page_type) {
        ...
        'secteur'  => "Page SECTEUR/QUARTIER immobilier. Structure : hero avec nom du quartier, description géographique et ambiance, chiffres clés (prix moyen/m², tendances), placeholder biens disponibles, points d'intérêt (écoles, commerces, transports), FAQ locale Schema.org, CTA contact.",
