...
$articles = [
    ‘prix-m2-etude-marche-bordeaux-via-perplexity’ => [
        ...
        ‘intro’   => "Cette page centralise les repères essentiels pour comprendre le marché bordelais : prix au m², dynamique de demande et signaux d’évolution. Les recherches sont appuyées par Perplexity pour accélérer la veille et croiser les sources.",
        ‘sections’ => [
            [
                ...
                ‘points’ => [
                    ‘Bordeaux intra-muros (Triangle d\’Or, Chartrons) : environ 4 500 € à 6 000 €/m².’,
                    ‘Caudéran / Saint-Augustin : bons rapports qualité/prix pour les maisons familiales.’,
    ...
    ‘default’ => [
        ...
        ‘sections’ => [
            [
                ...
                ‘texte’ => "Après une correction de 8 à 12% sur certains secteurs, les prix au m² semblent trouver un plancher. Le prix médian à Bordeaux intra-muros s’établit autour de 4 000 €/m² pour les appartements, contre 4 800 €/m² au pic de 2022.",
            ],
            [
                ‘titre’ => ‘Les secteurs les plus dynamiques’,
                ‘texte’ => "Chartrons, Saint-Seurin et Caudéran résistent mieux que le reste de la métropole, portés par une demande soutenue de familles et de jeunes actifs. En périphérie, Mérignac et Pessac offrent des opportunités intéressantes.",
            ],
        ],
    ],
];
